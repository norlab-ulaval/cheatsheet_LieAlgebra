...
\newcommand{\header}{
    \begin{tabular}{L{.2\linewidth} C{.5\linewidth} R{.25\linewidth}}
		\textcolor{gray}{J. Laconte} &% author
		\begin{minipage}{\linewidth}\centering%
		{\huge Lie Algebra for Robotics }\\ %
		{\small \href{http://asrl.utias.utoronto.ca/~tdb/}{Based on ``State Estimation for Robotics'' by Tim Barfoot}}%
		\end{minipage}&% Title
	\href{https://norlab.ulaval.ca/}{\includegraphics[height=2.5em]{cheatsheet_template/norlab_logo_acronym_dark.pdf}} %logo with url embedded
    \end{tabular}
